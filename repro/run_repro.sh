...
mkdir -p .tmp/local_langlands
cp artifacts/stitch_constants.json .tmp/local_langlands/stitch_constants.json
cp artifacts/constants_registry.json .tmp/local_langlands/constants_registry.json
