...
mkdir -p .repro_tmp/local_langlands
cp artifacts/stitch_constants.json .repro_tmp/local_langlands/stitch_constants.json
cp artifacts/constants_registry.json .repro_tmp/local_langlands/constants_registry.json
